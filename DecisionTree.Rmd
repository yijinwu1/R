...
<table BORDER="2">
  ...
  <tr>
    ...
    <td ALIGN=left>&nbsp;以判斷結果是否區分清楚，降低不純度，<br>&nbsp;來衡量特徵對於判斷目標的幫助&nbsp;</td>
    <td ALIGN=left>&nbsp;以資訊的複雜度出發，<br>&nbsp;探討新的特徵能否降低整體複雜度，進而更容易判斷&nbsp;</td>
 </tr>
  <tr>
  ...
  <tr>
    <td ALIGN=left colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;資訊增益(Information Gain)<br>
